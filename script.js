let countryFlag;
let countryFlagFreak;
let countriesSelect;
let countriesSelectFreak;

window.onload = () => {
  countryFlag = document.getElementById('country');
  countryFlagFreak = document.getElementById('country-freak');
  countries.map((country) => {
    let countryOption = document.createElement('option');
    countryOption.value = country.code.toLowerCase();
    countryOption.innerText = country.label;
...
function setCountryFlag(event) {
  ...
  countryFlag.classList.add(event.target.value);
}

function setCountryFlagFreak(event) {
  countryFlagFreak.classList = [];
  countryFlagFreak.classList.add('fflag', 'ff-lg', `fflag-${event.target.value}`);
}
